///
/// HybridNitroLunarRangePickerManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitrolunarrangepicker.views
...
import com.nitrolunarrangepicker.*

/**
 * Represents the React Native `ViewManager` for the "NitroLunarRangePicker" Nitro HybridView.
 */
public class HybridNitroLunarRangePickerManager: SimpleViewManager<View>() {
  /**
   * Represents the View and its last state snapshot (mutable)
   */
  private class HybridViewHolder(
    val hybridView: HybridNitroLunarRangePicker,
    var lastState: StateWrapper? = null,
  )

  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroLunarRangePicker::class.java)) {
  ...
  override fun getName(): String {
    return "NitroLunarRangePicker"
  }

  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroLunarRangePicker(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroLunarRangePickerStateUpdater.updateViewProps(hybridView, newState, oldState)
