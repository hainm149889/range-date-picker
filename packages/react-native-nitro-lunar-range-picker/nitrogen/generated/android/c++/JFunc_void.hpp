...
namespace margelo::nitro::nitrolunarrangepicker {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrolunarrangepicker/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrolunarrangepicker/Func_void_cxx;";
